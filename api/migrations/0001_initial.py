# Generated by Django 2.1.2 on 2018-10-19 14:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('UP', 'Up vote'), ('DOWN', 'Down vote')], max_length=4)),
                ('create_time', models.DateTimeField(default=datetime.datetime.now)),
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_thread', to='api.Thread'),
        ),
        migrations.AddField(
            model_name='post',
            name='sub_thread',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='api.SubThread'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
